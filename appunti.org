...
*** Parte 2
    ...
    *OFF*.
    ...
    dell'istruzione e ogni elemento della lista *OFF* perché
    un'operazione "on" potrebbe riaccenderle. Queste intersezioni
    saranno inserite nella lista *ON*.

    Infine lo stesso cuboide dell'istruzione deve essere inserito
    nella lista *ON*.
