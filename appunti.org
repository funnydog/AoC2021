...
*** Parte 1
    ...
    Per leggere agevolmente i dati è necessario leggere una quantità
    ...
    effettua il parsing dei pacchetti, restituendo un rappresentazione
    ad albero dei dati.

    La funzione interp1() parte dalla rappresentazione ad albero per
    produrre la somma delle versioni di tutti i pacchetti.
...
*** Parte 2
    ...
    Introduciamo la funzione interp2() che effettua i calcoli
    stabiliti per ogni tipo di pacchetto.

    Anche questa funzione è ricorsiva, dovendo percorrere l'albero.
