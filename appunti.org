...
*** Parte 1
    ...
    Alla funzione passiamo cur che è la posizione corrente, lst che è
    la lista delle posizioni già visitate, m il grafo della mappa.
